...
Motion::Project::App.setup do |app|
  ...
  app.identifier             = "fr.dbachet.timers.io"
  ...
  app.release do
    app.provisioning_profile = "/Users/le_daf/projects/Apple stuff/DistributionProfile.mobileprovision"
    app.codesign_certificate = "iPhone Distribution: Damien Bachet (6P6U976678)"
  end
end